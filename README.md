...
The top `Index` counter shows the current patient's position in the work queue, and `Done` shows how many patients have a saved globe registration transform.
